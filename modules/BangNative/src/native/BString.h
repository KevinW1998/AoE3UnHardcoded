...
class BString 
{
	void* m_ptr;
public:
	BANG_NATIVE_BINDING(0x133F) BString();
	BANG_NATIVE_BINDING(0x43AA0) BString(const BString& other);
	BANG_NATIVE_BINDING(0x1A12) BString(const wchar_t* str);
	BANG_NATIVE_BINDING(0xCA) ~BString();
